  ...
  return (
    <>
     <form onSubmit={onSubmitHandler} className='pt-5 px-5 sm:pt-12 sm:pl-16 '>
        ...
        <select name="category" id="" onChange={onChangeHandler} value={data.category}  className='w-40 mt-4 px-4 py-3 border text-gray-500'>
          <option value="Statup">Startup</option>
          <option value="Statup">Technology</option>
          <option value="Statup">Lifestyle</option>
        </select>
        <br />
